...
public class DefectiveDao {
    ...
    public int selectListCount(SqlSessionTemplate sqlSession){
        ...
        return sqlSession.selectOne("defectiveMapper.selectListCount", params);
    }
    ...
    public ArrayList<DefectiveProduction> selectList(SqlSessionTemplate sqlSession, PageInfo dpi){
        ...
        return new ArrayList<>(sqlSession.selectList("defectiveMapper.selectList", params, rowBounds));
    }
