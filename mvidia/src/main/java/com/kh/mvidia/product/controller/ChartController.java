...
public class ChartController {
    ...
    @GetMapping("/clist.bo")
    public String chartboard(Model model){ return "product/chartListView"; }
    ...
    public String chartDashboard(Model model){
        // 종료임박순 5개 일정만 조회
        List<ScheduleRegistration> schrList = cService.selectTop5ByEndDate();
    ...
    // 전체 일정 페이지
    @GetMapping("/scheduleList.bo")
    public String scheduleList(Model model){
        List<ScheduleRegistration> fullList = cService.selectAllSchedules();
